...
<div class="container vh-100 d-flex">
    <div class="justify-content-center w-50 m-auto align-items-center">
        ...
        @csrf
            ...
            <p class="my-4 font-bold text-center fw-bold">belum punya akun ? <span ><a class="text-decoration-none fw-normal fontColor1" href="{{ route('register') }}">daftar sekarang</a></span> </p>
